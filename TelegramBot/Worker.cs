...
namespace TelegramBot
{
    public class Worker : BackgroundService
    {
        ...
        List<string> Messages = new List<string>()
        {
            ...
            "\nНе забудьте добавить бота в список своих контактов и настроить уведомлени. Тогда вы всегда будете в курсе событий!",
        ...
        /// <summary>
        /// Проверка коррекности ввода даты и времени
        /// </summary>
        /// <param name="value"> Значение которое будет преобразовано в дату </param>
        /// <param name="time"> Значение которое будет записана скорректированная дата и время </param>
        /// <returs> Результат преобразования значения в дату и время </returs>
